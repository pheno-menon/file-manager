...
<div class="container">
      ...
      <div  class="form" style="padding-left: 33px">
		...
		<hr>
          ...
          <input type="password" id="password" name="password" required> 
                <p class="contact" style="height: 34px"><label for="repassword">Confirm your password</label></p> 
          <input type="password" id="repassword" name="repassword" required> 
            ...
            <option value="printer">Printer Client</option>
            </select><br><br>
            
            <p class="contact"><label for="course">I study..</label></p>
