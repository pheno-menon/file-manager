...
<h3 class="page-header">
                            <font color="green" >Files uploaded by various users</font>
                        </h3>
<div class="row">
<div class="col-lg-12">
...
<?php 
 ...
 <h3 class="page-header">
                            <font color="green" >Files uploaded by you</font>
                        </h3>
...
<form action="" method="post">
            ...
            <thead>
                ...
                <tbody>
                 ...
                 <?php
                 $currentusercourse = $_SESSION['username'];

$query = "SELECT * FROM uploads WHERE file_uploader = '$currentusercourse' AND status = 'approved' ORDER BY file_uploaded_on DESC";
$run_query = mysqli_query($conn, $query) or die(mysqli_error($conn));
if (mysqli_num_rows($run_query) > 0) {
while ($row = mysqli_fetch_array($run_query)) {
    $file_id = $row['file_id'];
