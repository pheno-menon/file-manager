...
<div id="wrapper">
	...
	<div class="form-group">
		...
		<input type="text" name="title" class="form-control" placeholder="Eg: Subject name" ">
	</div>

	<div class="form-group">
		<label for="post_tags">File Tags</label>
		<input type="text" name="tags" class="form-control" placeholder="Eg: Project, Assignment etc.." ">
	</div>
